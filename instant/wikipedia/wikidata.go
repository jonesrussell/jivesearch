...
type claims struct {
	...
	TimeZoneOffset []claim `json:"P2907"`
...
type Claims struct {
	...
	TimeZone       []Wikidata   `json:"time_zone,omitempty"`
	...
	TimeZoneOffset []Quantity   `json:"timezone_offset,omitempty"`
